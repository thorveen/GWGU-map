...
write.csv(final_locations, "selected.locations.>=2004.or.>=10.earlier.csv", 
          row.names = F)
...
black:selected colonies (n =`{r} n.colonies`) in black. grey: not survey targets. yellow center: covered by others (i.e. not needed to be surveyed by us) and green outer ring: National Park
