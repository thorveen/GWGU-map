...
- include colonies with active breeding (1 pair or more) starting from `{r} threshold_year`.

- include breeding location which have records before `{r} threshold_year` of number of breeding pairs larger than `{r} threshold_count`.

Selected colonies (n=`{r} n.colonies`) in black and not selected colonies in grey.
